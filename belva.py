...
# Bab 1: Variabel, Tipe Data, Array
...
remove_task_button = tk.Button(frame, text="Remove Task", command=remove_task)
remove_task_button.grid(row=3, column=1, padx=5, pady=5)

task_list = tk.Listbox(root, width=50)
task_list.pack(pady=10)

show_schedule_button = tk.Button(root, text="Show Complete Schedule", command=show_schedule)
